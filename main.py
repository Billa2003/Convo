...
body{
    background-image: url('https://www.imghippo.com/i/vnGL6334VUU.jpg');
...
<body>
  ...
  <h1 class="mt-3">𓆤『٭❲ 𝐀𝐫̽͜ɣ𝐚͢͡ŋ — ː ›🩶 🪽 </h1>
  </header>
  ...
  <footer class="footer">
    <p>&copy; 2022 ArYan.x3 Web To Web</p>
    <p> NaFRaT<a href="https://www.facebook.com/ArYan.x3?mibextid=ZbWKwL">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴀʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://wa.me/+918949732221" class="whatsapp-link">
